...
#' 
#' `umxDiscTwin` uses `lme`` to compute the beta of y on x in models eithere a) only controlling for non-independence, 
#' and models in MZ and DZ subsamples also conttrolling the controlling the between-family level of in the predictor.
#' 
...
#' * McGue, M., Osler, M., & Christensen, K. (2010). Causal Inference and Observational Research: The Utility of Twins. *Perspectives on Psychological Science*, **5**, 546-556. \url{https://journals.sagepub.com/doi/10.1177/1745691610383511}
#' @md
#' @examples
#' \dontrun{
#' data(twinData)
