...
#' 
#' If a `weightVar` is detected, these columns are used to create weighted twin models.
#' 
...
#'
#' If a weight variable is offered up, new weight models with `mzWeightMatrix` are created.
#'
#' **Data handling**
#' 
