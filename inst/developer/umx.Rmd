---
title: An Introduction to umx
subtitle: Functions to ease Structural Equation and Twin modelling
author: "Timothy C. Bates"
date: "`r Sys.Date()`"
slug: umx
githubEditURL: https://github.com/tbates/umx/edit/master/vignettes/umx.Rmd
output:
  knitr:::html_vignette:
    toc: yes
vignette: >
  %\VignetteIndexEntry{An Introduction to umx}
...
In the process of working in [behavior genetics](https://en.wikipedia.org/wiki/Twin_study), and then more general [structural equation modeling](https://en.wikipedia.org/wiki/Structural_equation_modeling), I found myself writing many functions to get things done quicker and more easily. It should make twin modeling and SEM easier for you also. The package is used at the [Boulder Twin Workshop](https://www.colorado.edu/ibg/workshop) and hundreds of researchers use some subset of its functionality. You can read (and cite) the following article if you learn or use `umx`:
...
This page shows examples of a handful of twin and general SEM functions in `umx`. For a full list of functions, see the help page `help(package = 'umx')`. There are more extensive (but not complete) tutorials at [https://tbates.github.io](https://tbates.github.io). The source package is available on Github: https://github.com/tbates/umx.
