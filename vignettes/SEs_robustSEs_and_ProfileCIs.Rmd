---
title: "Confidence Intervals and Standard Errors in SEM"
subtitle: "Standard Errors, Robust SEs, and Profile Likelihood CIs in umx"
...
Fitting a Structural Equation Model (SEM) yields **point estimates** (e.g., a path coefficient of $0.45$ or a variance component of $0.21$). However, scientific inference requires representing the **uncertainty** of these estimates. 

`umx` (and `OpenMx` underneath) provides three primary ways to assess uncertainty:
