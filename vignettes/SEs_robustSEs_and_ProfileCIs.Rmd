...
### Step 3: Profile likelihood CIs (optional / local)

Profile CIs re-optimize the model many times and can dominate package-check time. Demo locally with one or two parameters:

```{r profile_ci_specific, eval = FALSE}
