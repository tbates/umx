...
# Fit model
m1 = umxRAM("One_Factor_Model", data = demoOneFactor, type = "cov",
...
```{r summary_std, message=FALSE}
umxSummary(m1, std = TRUE, showEstimates = "std")
```

### Step 2: Request Robust Standard Errors
To obtain robust standard errors, we can apply the `imxRobustSE()` function from `OpenMx` to our fitted model:
...
```{r profile_ci, message=FALSE, warning=FALSE}
