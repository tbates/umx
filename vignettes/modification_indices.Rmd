...
This vignette uses the classic Holzinger & Swineford (1939) data ([`HS.ability.data`](https://openmx.ssri.psu.edu/reference/HS.ability.data)): fit a deliberately poor **one-factor** model (the worst of the usual teaching sequence), run **one** `umxMI()` call, then show a better three-factor alternative with `umxCompare()` (no second MI pass).
